...
import de.nak.librarymgmt.service.ProbeBuchVerlagComparator;

import com.opensymphony.xwork2.ActionSupport;

public class SortColumnVerlag extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		Comparator<ProbeBuch> comp = new ProbeBuchVerlagComparator();
