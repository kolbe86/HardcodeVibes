...
import de.nak.librarymgmt.service.ProbeBuchIsbnComparator;
import de.nak.librarymgmt.service.ProbeBuchTitelComparator;

import com.opensymphony.xwork2.ActionSupport;

public class SortColumnIsbn extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		Comparator<ProbeBuch> comp = new ProbeBuchIsbnComparator();
